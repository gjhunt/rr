...
out10 <- rrscale(Y2, trans_list = list(box_cox_negative = box_cox_negative), lims_list = list(box_cox_negative = c(-100, 
    100)), seed = 3251991, verbose = FALSE, run_parallel = FALSE, zeros = 1)
expect_true(out10$NT[1, 1] == 1)
expect_true(!is.na(out10$G[1, 1]))

out11 <- rrscale(Y2, trans_list = list(box_cox_negative = box_cox_negative), lims_list = list(box_cox_negative = c(-100, 
    100)), seed = 3251991, verbose = FALSE, run_parallel = FALSE, zeros = NA)
...
out12 <- rrscale(Y2, trans_list = list(box_cox_negative = box_cox_negative), lims_list = list(box_cox_negative = c(-100, 
    100)), seed = 3251991, verbose = FALSE, run_parallel = FALSE, opt_control = opt_control)
